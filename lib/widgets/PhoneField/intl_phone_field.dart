...
// ignore: must_be_immutable
class IntlPhoneFieldUpdated extends StatefulWidget {
  final bool obscureText;
  final TextAlign textAlign;
  final VoidCallback? onTap;
  ...
  @override
  _IntlPhoneFieldUpdatedState createState() => _IntlPhoneFieldUpdatedState();
}

class _IntlPhoneFieldUpdatedState extends State<IntlPhoneFieldUpdated> {
  late List<Map<String, dynamic>> _countryList;
  late Map<String, dynamic> _selectedCountry;
  late List<Map<String, dynamic>> filteredCountries;
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        color: Color.fromRGBO(232, 231, 255, 1),
      ),
      child: Row(
        children: <Widget>[
          _buildFlagsButton(),
          Expanded(
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                contentPadding: EdgeInsets.fromLTRB(0, 8, 24, 8),
              ),
              onSaved: (value) {
                  widget.onSaved?.call(
                    PhoneNumber(
