...
class SettingsOption extends StatefulWidget {
  ...
  const SettingsOption({Key? key, required this.biometricEnabled, required this.currentUserNo, required this.onTapEditProfile, required this.onTapLogout, required this.prefs, required this.type}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
      ...
      scaffold: Fiberchat.getNTPWrappedWidget(
        Scaffold(
          backgroundColor: Thm.isDarktheme(widget.prefs) ? storychatBACKGROUNDcolorDarkMode : storychatCONTAINERboxColorLightMode,
          appBar: AppBar(
            elevation: 0.4,
            leading: IconButton(
              icon: Icon(
            ...
            title: Text(
              ...
              style: TextStyle(color: pickTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget.prefs) ? storychatAPPBARcolorDarkMode : storychatAPPBARcolorLightMode), fontSize: 18.5),
            ),
            actions: [],
          ),
          body: ListView(
            children: [
                        ...
                        return Column(
                          ...
                          children: [
                            Container(
                              padding: EdgeInsets.fromLTRB(0, 19, 0, 10),
                              child: ListTile(
                                leading: customCircleAvatar(radius: 40, url: myDoc[Dbkeys.photoUrl]),
                                title: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 16,
                                    color: pickTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget.prefs) ? storychatBACKGROUNDcolorDarkMode : storychatBACKGROUNDcolorLightMode),
                                  ),
                                ),
                                subtitle: Padding(
                            ...
                            ListTile(
                                    ...
                                    ? Align(
                                        child: Padding(
                                          ...
                                          child: LinearProgressIndicator(
                                            backgroundColor: storychatPRIMARYcolor.withOpacity(0.4),
                                            valueColor: AlwaysStoppedAnimation<Color>(storychatPRIMARYcolor),
                                          ),
                                        ),
                                      )
                                    : Switch(
                                        activeColor: storychatPRIMARYcolor,
                                        ...
                                        onChanged: (b) async {
                                          if (b == true) {
                                            ...
                                            //subscribe to token
                                            await FirebaseMessaging.instance.subscribeToTopic('${widget.currentUserNo.replaceFirst(new RegExp(r'\+'), '')}').catchError((err) {
                                              debugPrint(
                                                'ERROR SUBSCRIBING NOTIFICATION' + err.toString(),
                                              );
                                            });
                                            ...
                                            await FirebaseMessaging.instance.unsubscribeFromTopic('${widget.currentUserNo.replaceFirst(new RegExp(r'\+'), '')}').catchError((err) {
                                              debugPrint(
                                                'ERROR SUBSCRIBING NOTIFICATION' + err.toString(),
                                              );
                                            });
                                        ...
                                        value: myDoc[Dbkeys.notificationTokens].length > 0 ? true : false,
                                      ),
                              ),
                              onTap: () {
                                // widget.onTapEditProfile();
                              ...
                              leading: Padding(
                                ...
                                child: Icon(
                                  ...
                                  color: storychatPRIMARYcolor.withOpacity(0.85),
                                  size: 26,
                                ),
                              ),
                              title: Text(
                              ...
                              subtitle: Padding(
                                ...
                                child: Text(
                                  getTranslated(context, 'generalnotificationdesc'),
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  style: TextStyle(fontSize: 14, color: storychatGrey),
                                ),
              ...
              if (IsShowLanguageChangeButtonInSettings == true && Language.languageList().length > 1)
                ListTile(
                  ...
                  subtitle: Padding(
                    ...
                    child: Text(
                      Language.languageList()
                          .firstWhere(
                            (element) => element.languageCode == (widget.prefs.getString(LAGUAGE_CODE) ?? DEFAULT_LANGUAGE_FILE_CODE),
                          )
                          .name,
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
              ...
              if (IsHIDELightDarkModeSwitchInApp == false)
                ListTile(
                  ...
                  subtitle: Padding(
                    padding: const EdgeInsets.only(top: 4),
                    child: Text(
                      !Thm.isDarktheme(widget.prefs) == false ? getTranslated(this.context, 'dark') : getTranslated(this.context, 'light'),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(fontSize: 14, color: storychatGrey),
                    ),
                        ...
                        return Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Icon(Icons.check_circle_outline_rounded, color: storychatGreenColor400, size: 45),
                                SizedBox(
                                  height: 20,
                                ),
                                Text(
                                  ...
                                  style: TextStyle(height: 1.3, color: storychatGrey),
                                )
                              ],
                            ),
                          ),
                          ...
                          child: Container(
                            ...
                            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  getTranslated(this.context, 'raiserequestdesc'),
                                  textAlign: TextAlign.center,
                                  style: TextStyle(color: pickTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget.prefs) ? storychatDIALOGColorDarkMode : storychatDIALOGColorLightMode), fontWeight: FontWeight.normal, fontSize: 16.5),
                                ),
                              ),
                              SizedBox(
                                height: 10,
                              ...
                              myElevatedButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    Map<String, dynamic> mapdata = {'title': 'Account Deletion Request by User', 'desc': 'User ${widget.currentUserNo} has requested to Delete account. Delete it from User Profile page. User Personal Chat, Profile Details will be deleted.', 'phone': '${widget.currentUserNo}', 'type': 'Account', 'time': time.millisecondsSinceEpoch, 'id': widget.currentUserNo};
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      getTranslated(context, 'requestsubmitted'),
                                                      textAlign: TextAlign.center,
                                                      style: TextStyle(
              ...
              observer.isLogoutButtonShowInSettingsPage == true ? Divider() : SizedBox(),
              observer.isLogoutButtonShowInSettingsPage == true
                  ? ListTile(
                      ...
                      title: Text(
                        ...
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(fontSize: 16, color: pickTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget.prefs) ? storychatBACKGROUNDcolorDarkMode : storychatBACKGROUNDcolorLightMode), fontWeight: FontWeight.w600),
                      ),
                    )
                  : SizedBox(),
              ...
              Padding(
                ...
                child: Text(
                  ...
                  textAlign: TextAlign.center,
                  style: TextStyle(color: storychatGrey, fontSize: 12),
                ),
              ),
              SizedBox(
                height: 17,
          ...
          return SimpleDialog(
            ...
            children: <Widget>[
              ListTile(
                  ...
                  onTap: () {
                    Navigator.of(context).pop();
                    Platform.isAndroid ? custom_url_launcher(ConnectWithAdminApp == true ? observer.userAppSettingsDoc!.data()![Dbkeys.newapplinkandroid] : RateAppUrlAndroid) : custom_url_launcher(ConnectWithAdminApp == true ? observer.userAppSettingsDoc!.data()![Dbkeys.newapplinkios] : RateAppUrlIOS);
                  }),
              Divider(),
              Padding(
                child: Text(
