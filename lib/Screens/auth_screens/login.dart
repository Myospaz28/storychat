...
class LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin {
        ...
        if (widget.prefs.getString('phonecode') == null) {
          for (final code in data) {
            if (locale.startsWith('${code}_') || locale.startsWith('$code-')) {
              ...
              await widget.prefs.setString('autoDetectedCountryCode', autoDetectedCountryCode ?? DEFAULT_COUNTTRYCODE_ISO);
            }
          }
        } else {
          autoDetectedCountryCode = widget.prefs.getString('autoDetectedCountryCode');
  ...
  Future<void> verifyPhoneNumber() async {
    ...
    // try {
    await firebaseAuth.verifyPhoneNumber(phoneNumber: (phoneCode! + _phoneNo.text).trim(), timeout: Duration(seconds: timeOutSeconds), verificationCompleted: verificationCompleted, verificationFailed: verificationFailed, codeSent: codeSent, codeAutoRetrievalTimeout: codeAutoRetrievalTimeout);
    // } catch (e) {
