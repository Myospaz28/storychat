              ...
              return Consumer<SmartContactProviderWithLocalStoreData>(
                builder: (context, availableContacts, _child) {
                  return Scaffold(
                    ...
                    body: availableContacts.searchingcontactsindatabase == true ? loading() : RefreshIndicator(
                      onRefresh: () async {
                        return availableContacts.fetchContacts(context, model, widget.currentUserNo, widget.prefs, true,);
                      },
                      child: availableContacts.contactsBookContactList!.isEmpty ? ListView(
                        children: [
                          Padding(
                              ...
                              onTap: () {
                                showModalBottomSheet(
                                  ...
                                  builder: (BuildContext context) {
                                    if (availableContacts.alreadyJoinedSavedUsersPhoneNameAsInServer.length == 0) {
                                      return Container(
                                        height: 270,
                                        child: Padding(
                                                    ...
                                                    if (sharedSecret != null && privateKey != null) {
                                                      ...
                                                      FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).collection(Dbkeys.lastSyncedContacts).doc(Dbkeys.lastSyncedContacts).set({
                                                        ...
                                                        FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).set(
                                                          {Dbkeys.lastSyncedContacts: availableContacts.alreadyJoinedSavedUsersPhoneNameAsInServer.length, Dbkeys.lastSyncedTime: t, Dbkeys.lastSyncedID: sharedSecret},
                                              ...
                                              if (wUser != null && wUser[Dbkeys.chatStatus] != null) {
                                                if (model.currentUser![Dbkeys.locked] != null && model.currentUser![Dbkeys.locked].contains(phone)) {
                                                  ChatController.authenticate(
                                                    ...
                                                    type: Fiberchat.getAuthenticationType(widget.biometricEnabled, model),
                                                    onSuccess: () {
