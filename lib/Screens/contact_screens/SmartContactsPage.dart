...
class _SmartContactsPageState extends State<SmartContactsPage> {
  ...
  readLocal() async {
    try {
      ...
      sharedSecret = (await e2ee.X25519().calculateSharedSecret(e2ee.Key.fromBase64(privateKey!, false), e2ee.Key.fromBase64(widget.model.currentUser![Dbkeys.publicKey], true))).toBase64();
      setState(() {});
    } catch (e) {
      sharedSecret = null;
      setState(() {});
    ...
    return PickupLayout(
        ...
        scaffold: Fiberchat.getNTPWrappedWidget(ScopedModel<DataModel>(
            ...
            child: ScopedModelDescendant<DataModel>(builder: (context, child, model) {
              return Consumer<SmartContactProviderWithLocalStoreData>(builder: (context, availableContacts, _child) {
                ...
                return Scaffold(
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            ...
                            await contactsProvider.fetchContacts(
                              ...
                              widget.prefs,
                              true,
                              isRequestAgain: widget.prefs.getBool('allowed-contacts') == true ? false : true,
                            );
                          },
                        ),
                        IconButton(
                    ...
                    body:
                        ...
                        availableContacts.searchingcontactsindatabase == true
                            ? loading()
                            : RefreshIndicator(
                                onRefresh: widget.prefs.getBool('allowed-contacts') == true
                                    ? () async {
                                        return availableContacts.fetchContacts(context, model, widget.currentUserNo, widget.prefs, true);
                                      }
                                    : () async {},
                                child: availableContacts.contactsBookContactList!.isEmpty
                                    ? ListView(children: [
                                        Padding(
                                            ...
                                            child: Center(
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(getTranslated(context, 'nocontacts'),
                                                  ...
                                                  IconButton(
                                                      onPressed: () async {
                                                        availableContacts.setIsLoading(true);
                                                        await availableContacts
                                                          ...
                                                          Future.delayed(const Duration(milliseconds: 500), () {
                                                            availableContacts.setIsLoading(false);
                                                          });
                                                        });
                                                        setState(() {});
                                                      },
                                    ...
                                    : ListView(
                                        ...
                                        children: [
                                          ListTile(
                                            tileColor: Thm.isDarktheme(widget.prefs) ? storychatCONTAINERboxColorDarkMode : storychatCONTAINERboxColorLightMode,
                                            ...
                                            title: Text(
                                              ...
                                              style: TextStyle(
                                                color: pickTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget.prefs) ? storychatCONTAINERboxColorDarkMode : storychatCONTAINERboxColorLightMode),
                                              ),
                                            ),
                                          ...
                                          if (observer.isWebCompatible == true)
                                            ListTile(
                                              tileColor: Thm.isDarktheme(widget.prefs) ? storychatCONTAINERboxColorDarkMode : storychatCONTAINERboxColorLightMode,
                                              leading: CircleAvatar(
                                                  backgroundColor: storychatSECONDARYolor,
                                              ...
                                              title: Text(
                                                getTranslated(context, 'synctoweb'),
                                                style: TextStyle(
                                                  color: pickTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget.prefs) ? storychatCONTAINERboxColorDarkMode : storychatCONTAINERboxColorLightMode),
                                                ),
                                              ),
                                              ...
                                              onTap: () {
                                                showModalBottomSheet(
                                                    ...
                                                    builder: (BuildContext context) {
                                                      return availableContacts.alreadyJoinedSavedUsersPhoneNameAsInServer.length == 0
                                                          ? Container(
                                                              height: 270,
                                                              child: Padding(
                                                                ...
                                                                child: Column(
                                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                                  children: [
                                                                    Icon(Icons.contact_phone, color: Colors.orange[400], size: 60),
                                                                    SizedBox(
                                                                      height: 30,
                                                                    ),
                                                                    Text(
                                                                      getTranslated(context, 'nocontactsavailable'),
                                                                      textAlign: TextAlign.center,
                                                                      style: TextStyle(
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      ...
                                                                      textAlign: TextAlign.center,
                                                                      style: TextStyle(color: pickTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget.prefs) ? storychatDIALOGColorDarkMode : storychatDIALOGColorLightMode), height: 1.3),
                                                                    ),
                                                                    SizedBox(
                                                                      height: 10,
                                                                    ),
                                                                    if (widget.model.currentUser!.containsKey(Dbkeys.lastSyncedTime))
                                                                      Text(
                                                                        ...
                                                                        textAlign: TextAlign.center,
                                                                        style: TextStyle(color: storychatGrey, fontSize: 11),
                                                                      ),
                                                                    SizedBox(
                                                                      height: 30,
                                                                    ),
                                                                    MySimpleButton(
                                                                      buttontext: getTranslated(context, 'syncnow'),
                                                                      buttoncolor: storychatPRIMARYcolor,
                                                                      onpressed: () async {
                                                                        try {
                                                                          ...
                                                                          if (sharedSecret != null && privateKey != null) {
                                                                            ...
                                                                            FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).collection(Dbkeys.lastSyncedContacts).doc(Dbkeys.lastSyncedContacts).set({
                                                                              ...
                                                                              //done sync
                                                                              FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).set({Dbkeys.lastSyncedContacts: availableContacts.alreadyJoinedSavedUsersPhoneNameAsInServer.length, Dbkeys.lastSyncedTime: t, Dbkeys.lastSyncedID: sharedSecret}, SetOptions(merge: true)).then((value) {
                                          ...
                                          availableContacts.alreadyJoinedSavedUsersPhoneNameAsInServer.length == 0
                                              ? SizedBox(
                                                  height: 0,
                                                )
                                              : ListView.builder(
                                                  ...
                                                  itemCount: availableContacts.alreadyJoinedSavedUsersPhoneNameAsInServer.length,
                                                  itemBuilder: (context, idx) {
                                                    DeviceContactIdAndName user = availableContacts.alreadyJoinedSavedUsersPhoneNameAsInServer.elementAt(idx);
                                                    String phone = user.phone;
                                                    String name = user.name ?? user.phone;
                                                    return FutureBuilder<LocalUserData?>(
                                                      future: availableContacts.fetchUserDataFromnLocalOrServer(widget.prefs, phone),
                                                      builder: (BuildContext context, AsyncSnapshot<LocalUserData?> snapshot) {
                                                        if (snapshot.hasData && snapshot.data != null) {
                                                          return ListTile(
                                                            tileColor: Thm.isDarktheme(widget.prefs) ? storychatCONTAINERboxColorDarkMode : storychatCONTAINERboxColorLightMode,
                                                            leading: customCircleAvatar(url: snapshot.data!.photoURL, radius: 22),
                                          ...
                                          ListView.builder(
                                            ...
                                            itemCount: inviteContactsCount >= availableContacts.contactsBookContactList!.length ? availableContacts.contactsBookContactList!.length : inviteContactsCount,
                                            itemBuilder: (context, idx) {
                                              MapEntry user = availableContacts.contactsBookContactList!.entries.elementAt(idx);
                                              String phone = user.key;
                                              return availableContacts.previouslyFetchedKEYPhoneInSharedPrefs.indexWhere((element) => element.phone == phone) >= 0
                                                  ? Container(
                                                      width: 0,
                                                    )
                                                  : Stack(
