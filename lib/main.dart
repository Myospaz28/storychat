...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  if (message.data['title'] == 'Call Ended' || message.data['title'] == 'Missed Call') {
    ...
    await showNotificationWithDefaultSound('Missed Call', 'You have Missed a Call', titleMultilang, bodyMultilang);
  } else {
...
void main() async {
  ...
  if (IsBannerAdShow == true || IsInterstitialAdShow == true || IsVideoAdShow == true) {
              ...
              builder: (context, AsyncSnapshot<SharedPreferences> snapshot) {
                if (snapshot.hasData) {
                  return MultiProvider(
                    providers: [
                      ChangeNotifierProvider(create: (_) => FirestoreDataProviderMESSAGESforBROADCASTCHATPAGE()),
                      //---
                      ChangeNotifierProvider(create: (_) => StatusProvider()),
                      ChangeNotifierProvider(create: (_) => TimerProvider()),
                      ChangeNotifierProvider(create: (_) => FirestoreDataProviderMESSAGESforGROUPCHAT()),
                      ChangeNotifierProvider(create: (_) => FirestoreDataProviderMESSAGESforLAZYLOADINGCHAT()),
                      ChangeNotifierProvider(create: (_) => DarkThemeProvider()),
                      ChangeNotifierProvider(create: (_) => SmartContactProviderWithLocalStoreData()),
                ...
                return MultiProvider(
                  ...
                  child: MaterialApp(
                    theme: ThemeData(
                      ...
                      primaryColor: storychatPRIMARYcolor,
                      primaryColorLight: storychatPRIMARYcolor,
